...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/nrdp_audio_platform_capabilities.json:$(TARGET_COPY_OUT_VENDOR)/etc/nrdp_audio_platform_capabilities.json \
...
# Inherit vendor
$(call inherit-product, vendor/jio/franklin/franklin-vendor.mk)